                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        if (_match(['jlpt', 'кандзи', 'уровень', 'n5', 'n1']))
                          _Category(
                            title: 'Уровни кандзи',
                            child: Wrap(
                              spacing: 8,
                        ...
                        if (_match(['кана', 'хирагана', 'катакана', 'ряд']))
                          _Category(
                            title: 'Кана',
                            child: Column(
                              ...
                              children: [
                                _SliderTile(
                                  ...
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.weighted =
                                        x.weighted.copyWith(penalty: v),
                                  ),
                                ),
                                _SliderTile(
                                  label: 'Затухание после верного ответа',
                                  ...
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.weighted =
                                        x.weighted.copyWith(decay: v),
                                  ),
                                ),
                                _SliderTile(
                                  label: 'Множитель подсказки (Enter)',
                                  value: s.weighted.revealMultiplier,
                                  min: 1,
                                  max: 5,
                                  divisions: 8,
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.weighted = x.weighted
                                        .copyWith(revealMultiplier: v),
                                  ),
                                ),
                                FilledButton.tonal(
                                  onPressed: () =>
                                      widget.controller.resetWeights(),
                                  child: const Text('Сбросить веса'),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Column(
                              children: [
                                SwitchListTile(
                                  ...
                                  onChanged: (v) => widget.controller
                                      .update((x) => x.kanjiShowMeaning = v),
                                ),
                                _SliderTile(
                                  label: 'Вес количества черт',
                                  value: s.kanjiUtility.strokeWeight,
                                  min: 0,
                                  max: 3,
                                  divisions: 12,
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.kanjiUtility =
                                        x.kanjiUtility.copyWith(strokeWeight: v),
                                  ),
                                ),
                                _SliderTile(
                                  label: 'Вес частоты',
                                  value: s.kanjiUtility.frequencyWeight,
                                  min: 0,
                                  max: 3,
                                  divisions: 12,
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.kanjiUtility = x.kanjiUtility
                                        .copyWith(frequencyWeight: v),
                                  ),
                                ),
                                _SliderTile(
                                  label: 'Вес знаний',
                                  value: s.kanjiUtility.knowledgeWeight,
                                  min: 0,
                                  max: 3,
                                  divisions: 12,
                                  onChanged: (v) => widget.controller.update(
                                    (x) => x.kanjiUtility = x.kanjiUtility
                                        .copyWith(knowledgeWeight: v),
                                  ),
                                ),
                              ],
                            ),
